    ...
    switch (n.type) {
        ...
        case "ImportDeclaration": {
            ...
            if (n.assertions && n.assertions.length > 0) {
                parts.push(' assert', ' {');
                var assertList_1 = [];
                path.each(function (assertPath) {
                    var key = assertPath.call(print, "key");
                    var value = assertPath.call(print, "value");
                    assertList_1.push(key + ": " + value);
                }, "assertions");
                parts.push(assertList_1.join(', '), '}');
            }
            parts.push(';');
            return lines_1.concat(parts);
        }
